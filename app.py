...
# Load the local fine-tuned model for English to Sinhala
tokenizer_en_to_si = MarianTokenizer.from_pretrained(local_model_path)
model_en_to_si = MarianMTModel.from_pretrained(local_model_path)

# Load the pre-trained model for Sinhala to English
